    ...
    <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-raleway mb-4" data-aos="fade-up" data-aos-delay="100">
            We'd love to hear from you. Send us a message anytime!
          </p>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="150">
            Have questions about Webix_EventHub? Need support with your events? Our dedicated team is here to help you succeed.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8" data-aos="fade-left">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Indore MR10 Road<br />Aditya Gateway 7th floor B-704<br />India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@webixinfotech.com" className="text-primary-400 hover:text-primary-300">
                      info@webixinfotech.com
                    </a>
                    <br />
                    <a href="mailto:support@webixinfotech.com" className="text-primary-400 hover:text-primary-300">
                      support@webixinfotech.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919926820304" className="text-primary-400 hover:text-primary-300">
                      +91 99268 20304
                    </a>
                  </div>
                </div>
            ...
            <div className="glass rounded-2xl p-2 overflow-hidden">
              ...
              <div className="glass rounded-2xl p-2 overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3678.947792511943!2d75.86377520891344!3d22.767318679267298!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3963031e7fc14463%3A0x5a3872e9756159c2!2sWebix%20Infotech!5e0!3m2!1sen!2sin!4v1776322240551!5m2!1sen!2sin"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen
