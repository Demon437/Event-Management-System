    ...
    <footer className="glass-dark text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold font-montserrat">
                Webix<span className="text-primary-400">_EventHub</span>
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-sm">Indore MR10 Road, Aditya Gateway 7th floor B-704, India</span>
              </li>
              <li className="flex items-center space-x-3">
                <FaEnvelope className="text-primary-400 flex-shrink-0" />
                <a href="mailto:info@webixinfotech.com" className="text-gray-400 text-sm hover:text-primary-400">info@webixinfotech.com</a>
              </li>
              <li className="flex items-center space-x-3">
                <FaPhone className="text-primary-400 flex-shrink-0" />
                <a href="tel:+919926820304" className="text-gray-400 text-sm hover:text-primary-400">+91 99268 20304</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Webix_EventHub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
